...
describe("ProfileNewAddress", () => {
  ...
  it("renders address name", () => {
    createComponent({ localVue, store, propsData });
    wrapper.find("[data-test='addressName']").element.value =
      wrapper.vm.addressName;
    expect(wrapper.find("[data-test='addressName']").element.value).toBe(
      propsData.name
    );
  });
  ...
  it("renders address street", () => {
    createComponent({ localVue, store, propsData });
    wrapper.find("[data-test='addressStreet']").element.value =
      wrapper.vm.addressStreet;
    expect(wrapper.find("[data-test='addressStreet']").element.value).toBe(
      propsData.street
    );
  });
  ...
  it("renders address building", () => {
    createComponent({ localVue, store, propsData });
    wrapper.find("[data-test='addressBuilding']").element.value =
      wrapper.vm.addressBuilding;
    expect(wrapper.find("[data-test='addressBuilding']").element.value).toBe(
      propsData.building
    );
  });
  ...
  it("renders address flat", () => {
    createComponent({ localVue, store, propsData });
    wrapper.find("[data-test='addressFlat']").element.value =
      wrapper.vm.addressFlat;
    expect(wrapper.find("[data-test='addressFlat']").element.value).toBe(
      propsData.flat
    );
  });
  ...
  it("renders address comment", () => {
    createComponent({ localVue, store, propsData });
    wrapper.find("[data-test='addressComment']").element.value =
      wrapper.vm.addressComment;
    expect(wrapper.find("[data-test='addressComment']").element.value).toBe(
      propsData.comment
    );
  });
